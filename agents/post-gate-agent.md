...
Write(.local/state/code-foundations/building/scratch.sh)  # your commands here
Bash(bash .local/state/code-foundations/building/scratch.sh)

# Iterate by editing the script and re-running
Edit(.local/state/code-foundations/building/scratch.sh)   # fix/add commands
Bash(bash .local/state/code-foundations/building/scratch.sh)
```
...
|--------|---------|----------|
| Discovery + Design file (`.local/state/code-foundations/building/*-discovery.md`) | What exists, gaps, design decisions | YES |
...
Write review to: `.local/state/code-foundations/building/<plan-name>-phase-N-review.md`
...
**Return:** `POST-GATE [PASS|FAIL]. Review written to .local/state/code-foundations/building/<plan-name>-phase-N-review.md`
