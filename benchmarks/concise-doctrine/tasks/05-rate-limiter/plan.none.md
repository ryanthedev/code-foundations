...
Implement a sliding-window rate limiter in Python. Adherence-test task (no-skill control): the build agent under test produces `outputs/rate_limiter.py` + `outputs/test_rate_limiter.py`.
