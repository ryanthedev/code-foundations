...
Implement a sliding-window rate limiter in Python. This is a greenfield benchmark task for the concise-code-doctrine A/B evaluation. The build agent under test produces `outputs/rate_limiter.py` + `outputs/test_rate_limiter.py`.
