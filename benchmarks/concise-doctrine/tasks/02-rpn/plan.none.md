...
Implement an RPN expression evaluator in Python. Adherence-test task (no-skill control): the build agent under test produces `outputs/rpn.py` + `outputs/test_rpn.py`.
