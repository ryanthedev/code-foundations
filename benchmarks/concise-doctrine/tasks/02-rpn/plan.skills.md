...
Implement an RPN expression evaluator in Python. This is a benchmark task for the checklist-delivery (read vs skill-load) A/B evaluation. The build agent under test produces `outputs/rpn.py` + `outputs/test_rpn.py`.
