...
export interface R2Client {
   ...
   * object doesn't exist, or rejects on a network/transport error. Transport
   * retry/timeout policy is NOT this module's concern — production wraps
   * `headObject` in ./retry.ts's helpers a layer below.
   */
