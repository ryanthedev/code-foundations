...
description: "Use before claiming code is 'done', after implementation, before commit. Checks requirements coverage, concurrency, error handling, resources, boundaries, and security. NEW capability not in CC skills."
---
