...
description: "Enforce strategic programming discipline when modifying existing code. Use when fixing bugs, extending features, or tempted to make quick fixes."
---
